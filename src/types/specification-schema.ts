...
export interface UintArg {
    /**
     * Type discriminator for uint argument
     */
    $: "uint"
    /**
     * Length of the argument in bits
...
export interface IntArg {
    /**
     * Type discriminator for int argument
     */
    $: "int"
    /**
     * Length of the argument in bits
...
export interface RefsArg {
    /**
     * Type discriminator for refs argument
     */
    $: "refs"
    /**
...
export interface DeltaArg {
    /**
     * Type discriminator for delta argument
     */
    $: "delta"
    /**
     * Delta value
...
export interface StackArg {
    /**
     * Type discriminator for stack argument
     */
    $: "stack"
    /**
     * Length of the argument in bits
...
export interface ControlArg {
    /**
     * Type discriminator for control argument
     */
    $: "control"
    range: ArgRange4
}
...
export interface PlduzArg {
    /**
     * Type discriminator for plduz argument
     */
    $: "plduzArg"
    range: ArgRange5
}
...
export interface TinyIntArg {
    /**
     * Type discriminator for tinyInt argument
     */
    $: "tinyInt"
    range: ArgRange6
}
...
export interface LargeIntArg {
    /**
     * Type discriminator for largeInt argument
     */
    $: "largeInt"
    range: ArgRange7
}
...
export interface RunvmArg {
    /**
     * Type discriminator for runvm argument
     */
    $: "runvmArg"
}
export interface HashArg {
    /**
     * Type discriminator for hash argument
     */
    $: "hash"
}
export interface MinusOneArg {
    /**
     * Type discriminator for minusOne argument
     */
    $: "minusOne"
}
export interface S1Arg {
    /**
     * Type discriminator for s1 argument
     */
    $: "s1"
}
export interface SetcpArg {
    /**
     * Type discriminator for setcp argument
     */
    $: "setcpArg"
    range: ArgRange8
}
...
export interface SliceArg {
    /**
     * Type discriminator for slice argument
     */
    $: "slice"
    /**
...
export interface CodeSliceArg {
    /**
     * Type discriminator for codeSlice argument
     */
    $: "codeSlice"
    /**
...
export interface RefCodeSliceArg {
    /**
     * Type discriminator for refCodeSlice argument
     */
    $: "refCodeSlice"
}
export interface InlineCodeSliceArg {
    /**
     * Type discriminator for inlineCodeSlice argument
     */
    $: "inlineCodeSlice"
    /**
...
export interface ExoticCellArg {
    /**
     * Type discriminator for exoticCell argument
     */
    $: "exoticCell"
}
export interface DebugstrArg {
    /**
     * Type discriminator for debugstr argument
     */
    $: "debugstr"
}
/**
...
/**
 * Value range for references
 */
export interface ArgRange9 {
    /**
     * Minimum value for the argument range
     */
    min: string
